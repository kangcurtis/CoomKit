...
RECIPES = {
    ...
    "asmr": {
        ...
        "brief": (
            ...
            "Lean on the non-verbal tags and on punctuation, because the "
            "model has no other way to perform this. The tags are an EXACT "
            "list and it is short: [sigh] and [laughter] are breath and are "
            "the safest; [confirmation-en] is 'mmm', [dissatisfaction-hnn] "
            "is 'hmph', [question-ah]/[question-oh]/[question-ei] and "
            "[surprise-oh]/[surprise-wa]/[surprise-yo] are the vowel she "
            "makes. Do NOT use [sniff] — on this build it is pronounced as "
            "the word. Anything else in brackets — [moan], [gasp], [kiss], "
            "[wet] — is READ OUT as that word, in her voice, mid-line. Never "
            "invent one. "
            "Ellipses slow her down, a line break is a beat, a short "
