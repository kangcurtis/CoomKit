...
OFFLINE=(test_frontend test_llm test_comfy test_api test_cards test_comfy_api
         ...
         test_export test_vram_kcpp test_vram_lcpp test_cast test_baton
         test_lore test_theme test_cftf test_memory_scope test_vision
         test_empty_turn test_voiceclip test_fixes)
